...
- **Рухомі хмари** — Фотореалістичні анімовані хмари з паралакс-ефектом, оброблені з точним Alpha-каналом для ідеального злиття з небом.

### 🔔 Фонове сповіщення
- **Розумні अलर्टи** — Додаток перевіряє погоду у фоновому режимі (навіть коли він закритий).
- **Кастомні фільтри** — Отримуйте сповіщення лише про те, що вас цікавить (Дощ, Заморозки нижче 0°C, або Регулярні ранкові/вечірні звіти).
- **Історія сповіщень** — Зберігається локально, щоб ви могли переглянути всі минулі погодні попередження.
...
<div align="center">
  <img src="assets/demo/kyiv_weather.gif" width="300" alt="Погода Київ" />
  &nbsp;&nbsp;&nbsp;&nbsp;
  <img src="assets/demo/settings_weather.gif" width="300" alt="Налаштування" />
</div>
...
└── widgets/         # Перевикористовувані компоненти
    ...
    ├── moving_clouds_overlay.dart      # Анімовані фотореалістичні хмари
